    ...
    _.init = function(){
         var center={lon: 114.302312702, lat: 30.598026044};
           var points=[
               ...
               {"lon": 110.795000473,"lat": 32.638540762,image:"../images/arrow.png"},
               {"lon": 111.267729446,"lat": 30.698151246},
               {"lon": 112.126643144,"lat": 32.058588576},
               {"lon": 114.885884938,"lat": 30.395401912},
               {"lon": 112.190419415,"lat": 31.043949588,image:"../images/my_head.png"},
           ...
           this.create(center,points);
        
    }
    
    
    _.create = function(center,points){
   
           var data={
               image:"../images/logo.png", //如果有其他需求 就直接修改ysc内部代码吧 这边就简单写几个参数
               center:center,
               points:points,
           ...
           var dsArr=ysc.creatFlyLinesByCzml(viewer,data); // shouldAnimate : true,//允许动画 //这个得必须有！！
           setTimeout(function () {
           ...
           var data2={
               image:"../images/dot.png", //如果有其他需求 就直接修改ysc内部代码吧 这边就简单写几个参数
           ...
           _cesium.creatFlyLinesByCzml(viewer,data2); // shouldAnimate : true,//允许动画 //这个得必须有！！
    }
    return _;
})();
