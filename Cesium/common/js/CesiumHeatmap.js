...
function convertCanvasToImage(canvas) {
   ...
   * @version v1
   */
  var cesiumHeatMap = null;
  CesiumHeatMap = function(){
    cesiumHeatMap = this;
      _heatmap = null;
  }
	//创建
	CesiumHeatMap.prototype.build = function(param){
		var t = this;this.heatmap = null;
		switch(param.handleType){
			 case "CesiumHeatmap":{ 
            if (this._heatmap == null) {
              this._heatmap = new CesiumHeatmap(param.viewer, param.datas)
            };
            break; 
        }
        case "CesiumHeatmapGL":{
          if (this._heatmap == null) {
            this._heatmap = new CesiumHeatmapGL(param.viewer, param.datas)
          };
          break; 
      }
		}
	...
	CesiumHeatMap.prototype.clear = function(){
    this._heatmap.clear();
