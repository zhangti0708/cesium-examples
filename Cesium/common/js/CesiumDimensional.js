...
var CesiumMoveScan = (function(){
    ...
    _.initSelect = function(){ //创建默认初始化数据
        tableparam	 = [	
            ...
            {id:"_ids2",type:"select",key:"source",value:["../data/moveScan.json"],code:["../data/moveScan.json"]},
...
CesiumRadar.prototype.setPixelRange = function(value){
     ...
     var toolbar = '<div id="toolbar">'+
        '<table>'+
            ...
            '<tr>'+
                ...
                '<td>'+
                    '<input type="range" min="2" max="200" step="1" data-bind="value: minimumClusterSize, valueUpdate: "input" ">'+
...
CesiumRadar.prototype.clear = function(){
    var t = this;
...
CesiumRadar.prototype.loadKml = function(param){
    ...
    var data = dataSourcePromise.then(function(dataSource) {
        if(dataSource != null){
            try {
