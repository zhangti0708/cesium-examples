...
var CesiumFlyPath = (function(){
    ...
    _.initSelect = function(){
        tableparam = [
            ...
            {id:"_ids2",type:"select",key:"cities",value:["../../../3dmap/common/data/flyPath.json"],code:["../../../3dmap/common/data/flyPath.json"]},
    ...
    _.config = function(){
       ...
       //绘制位置在地形上
        ...
        Cesium.Material.PolylineTrailLinkImage = "../../../3dmap/common/data/images/colors1.png";
         //着色器
...
var TileLonlatController = (function(){
    ...
    _.createMgrs = function(){
      /* var mapMgrs = new Cesium.WebMapServiceImageryProvider({
       ...
       viewer.dataSources.add(Cesium.KmlDataSource.load("../../../3dmap/common/data/EarthPointGrid_093357.kml", options));

        this.initController("mgrs");
        ...
        try {
            var t = this;
             ...
             System = new Cesium.ParticleSystem({
                 ...
                 startScale : 0.5,
                 endScale : 1.0,
                 image : '../../../3dmap/Apps/SampleData/snowflake_particle.png',
        ...
        try {
            ...
            // rain
             ...
             System = new Cesium.ParticleSystem({
                 ...
                 startScale : 1.0,
                 endScale : 0.0,
                 image : '../../../3dmap/Apps/SampleData/circular_particle.png',
 ...
 /************************************************* CesiumHeatMap start    ***************************************************** */
  ...
  _.initSelect = function(){
    tableparam = [
        ...
        {id:"_ids3",type:"select",key:"obj",value:['../../../3dmap/common/data/busstop2016.geojson'],code:['../../../3dmap/common/data/busstop2016.geojson']} 
    ]
    var table = createTable(tableparam);
    $("#content").empty().append(table);
    $("#content select,input").css("width","200px");
...
var CesiumMoveScan = (function(){
    ...
    _.initSelect = function(){ //创建默认初始化数据
        tableparam	 = [	
            ...
            {id:"_ids2",type:"select",key:"source",value:["../../../3dmap/common/data/moveScan.json"],code:["../../../3dmap/common/data/moveScan.json"]},
...
var CesiumRadar2 = (function(){
    ...
    _.radarStyle02 = function(){
        ...
        entity = new Cesium.RadarPrimitive(viewer, {
    ...
    _.remove = function (){
        ...
        if(viewer != null)viewer.entities.remove(entity);
    }
    return _;
})();
/********************************************************  CesiumRadar2 end    ***************************************************** */