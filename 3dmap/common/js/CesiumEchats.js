...
var cityScatterTable = (function(){
    ...
    _.initSelect = function(){
        tableparam = [
            ...
            {id:"_ids2",type:"select",key:"source",value:["../../../3dmap/common/data/city.json"],code:["../../../3dmap/common/data/city.json"]},
 ...
 var flightTable = (function(){
    ...
    _.initSelect = function(){
        tableparam = [
            ...
            {id:"_ids2",type:"select",key:"source",value:["../../../3dmap/common/data/flight.json"],code:["../../../3dmap/common/data/flight.json"]},
