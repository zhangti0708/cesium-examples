 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2019-11-21 10:33:32
 */
/**
 * 模型封装
 * 常用模型
...
export default class ModelManager{
     ...
     */
    createAir(position){
       return this.createDefault({id:'air',url:'../Apps/SampleData/models/CesiumAir/Cesium_Air.gltf',position:position});
    }
    /**
     * 创建碉堡
     */
    createWoodTower(position){
        return this.createDefault({id:'woodTower',url:'../Apps/SampleData/models/WoodTower/Wood_Tower.gltf',position:position});
     }
    /**
     * 创建汽车
     */
    createCar(position){
        return this.createDefault({id:'car',url:'../Apps/SampleData/models/car/model.gltf',position:position});
     }
}