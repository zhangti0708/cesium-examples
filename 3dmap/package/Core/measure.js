 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2019-11-18 11:04:28
 */
...
export default class Measure{
    ...
    constructor(core){
        ...
        */
        ...
        this.triangleSpace = {
            ...
            createLine(_self){
                _self.triangleSpace.lineObj[0] = new entityFactory({type:"triangleMeasure",data:{name:'直线',positions:_self.triangleSpace.position1,label:{fn:_self.triangleSpace.getDistance,scaler:1000,unit:'公里',offset:new Cesium.Cartesian2(20, -40)}}});
                _self.triangleSpace.lineObj[1] = new entityFactory({type:"triangleMeasure",data:{name:'等经纬线',positions:_self.triangleSpace.position2,label:{fn:_self.triangleSpace.getHeight,scaler:1,unit:'米',offset:new Cesium.Cartesian2(20, -20)}}});
                _self.triangleSpace.lineObj[2] = new entityFactory({type:"triangleMeasure",data:{name:'等高度直线',positions:_self.triangleSpace.position3,label:{fn:_self.triangleSpace.getDistance,scaler:1000,unit:'公里',offset:new Cesium.Cartesian2(60, -20)}}});  
    ...
    */ 
    drawTriangle(){
         ...
         * 移动
         */
        _self.handlerAction.Actions(function(e){},function(e){ //两个
