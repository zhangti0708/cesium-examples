...
var newFlyPath = (function(){
    ...
    _.initSelect = function(){ //创建默认初始化数据
        tableparam	 = [
            ...
            {id:"_ids2",type:"select",key:"sources",value:["../common/3d/data/newFlyPath.json"],code:["../common/3d/data/newFlyPath.json"]},
            {id:"_ids3",type:"select",key:"image",value:["../common/3d/img/plane.png"],code:["../common/3d/img/plane.png"]},
