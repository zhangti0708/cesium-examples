    ...
    _._createProvider = function(param){
     ...
     _.initSelect = function(){ //创建默认初始化数据
        tableparam	 = [
            ...
            {id:"_ids2",type:"select",key:"source",value:["../common/3d/data/vector/bjsx.json",'../common/3d/js/mgrs_index_ftp_link.shp'],code:["../common/3d/data/vector/bjsx.json",'../common/3d/js/mgrs_index_ftp_link.shp']},
